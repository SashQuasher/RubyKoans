...
class AboutClassMethods < Neo::Koan
  ...
  def test_you_can_define_methods_on_individual_objects
    fido = Dog.new
    def fido.wag #hERE THE METHOD wag IS DEFINED INSIDE FIDO OBJECT.
      :fidos_wag
    end
  ...
  def test_other_objects_are_not_affected_by_these_singleton_methods
    ...
    assert_raise(Exception) do
      rover.wag #The wag method was created inside Fido object not on Rover
    end
  end
  ...
  def test_heres_still_another_way_to_write_class_methods
    assert_equal :still_another_way, Dog.another_class_method #self inheritage??
  end
  ...
  # Self way is better for me, I think it feels more natural.
  # In general I prefer the self method as I explained above.
